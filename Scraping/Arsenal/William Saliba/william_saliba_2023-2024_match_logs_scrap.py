...
# URL untuk William Saliba Match Logs
URL = "https://fbref.com/en/players/972aeb2a/matchlogs/2023-2024/William-Saliba-Match-Logs"
...
def scrape_match_logs_to_json(url):
    ...
    for table in tables:
        if "matchlogs" in table.get("id", ""):  # Pastikan tabel memiliki ID mengandung "matchlogs"
            ...
            with open("william_saliba_match_logs_2023_2024.json", "w", encoding="utf-8") as json_file:
                json.dump(match_data, json_file, indent=4, ensure_ascii=False)

            print("Data has been saved to 'william_saliba_match_logs_2023_2024.json'")
            return match_data
