...
# URL untuk Jack Grealish Match Logs
URL = "https://fbref.com/en/players/b0b4fd3e/matchlogs/2023-2024/Jack-Grealish-Match-Logs"
...
OBJECT_NAME = "jack_grealish_match_logs_2023_2024.json"
...
def scrape_match_logs_to_json(url):
    ...
    for table in tables:
        if "matchlogs" in table.get("id", ""):  
            ...
            json_file_path = "jack_grealish_match_logs_2023_2024.json"
            with open(json_file_path, "w", encoding="utf-8") as json_file:
                json.dump(match_data, json_file, indent=4, ensure_ascii=False)

            print("Data has been saved to 'jack_grealish_match_logs_2023_2024.json'")
