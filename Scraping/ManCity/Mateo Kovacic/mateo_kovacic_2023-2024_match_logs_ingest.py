...
# URL untuk Mateo Kovacic Match Logs
URL = "https://fbref.com/en/players/79c0821a/matchlogs/2023-2024/Mateo-Kovacic-Match-Logs"
...
OBJECT_NAME = "mateo_kovacic_match_logs_2023_2024.json"
...
def scrape_match_logs_to_json(url):
    ...
    for table in tables:
        if "matchlogs" in table.get("id", ""):  
            ...
            json_file_path = "mateo_kovacic_match_logs_2023_2024.json"
            with open(json_file_path, "w", encoding="utf-8") as json_file:
                json.dump(match_data, json_file, indent=4, ensure_ascii=False)

            print("Data has been saved to 'mateo_kovacic_match_logs_2023_2024.json'")
