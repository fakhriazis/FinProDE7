...
# URL untuk Ederson Match Logs
URL = "https://fbref.com/en/players/3bb7b8b4/matchlogs/2023-2024/Ederson-Match-Logs"
...
OBJECT_NAME = "ederson_match_logs_2023_2024.json"
...
def scrape_match_logs_to_json(url):
    ...
    for table in tables:
        if "matchlogs" in table.get("id", ""):  
            ...
            json_file_path = "ederson_match_logs_2023_2024.json"
            with open(json_file_path, "w", encoding="utf-8") as json_file:
                json.dump(match_data, json_file, indent=4, ensure_ascii=False)

            print("Data has been saved to 'ederson_match_logs_2023_2024.json'")
