...
MINIO_FILE_KEY = 'william_saliba_match_logs_2023_2024.json'
...
def load_data_to_postgres():
    ...
    df.to_sql('william_saliba_logs', engine, if_exists='replace', index=False)
...
dag = DAG(
    dag_id= 'william_saliba_to_postgres_etl',
