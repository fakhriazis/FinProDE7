...
MINIO_FILE_KEY = 'oleksandr_zinchenko_match_logs_2023_2024.json'
...
def load_data_to_postgres():
    ...
    df.to_sql('oleksandr_zinchenko_logs', engine, if_exists='replace', index=False)
...
dag = DAG(
    dag_id= 'oleksandr_zinchenko_to_postgres_etl',
