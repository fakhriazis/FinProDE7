...
MINIO_FILE_KEY = 'martin_odegaard_match_logs_2023_2024.json'
...
def load_data_to_postgres():
    ...
    df.to_sql('martin_odegaard_logs', engine, if_exists='replace', index=False)
...
dag = DAG(
    dag_id= 'martin_odegaard_to_postgres_etl',
