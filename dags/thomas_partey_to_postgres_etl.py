...
MINIO_FILE_KEY = 'thomas_partey_match_logs_2023_2024.json'
...
def load_data_to_postgres():
    ...
    df.to_sql('thomas_partey_logs', engine, if_exists='replace', index=False)
...
dag = DAG(
    dag_id= 'thomas_partey_to_postgres_etl',
