...
MINIO_FILE_KEY = 'gabriel_martinelli_match_logs_2023_2024.json'
...
def load_data_to_postgres():
    ...
    df.to_sql('gabriel_martinelli_logs', engine, if_exists='replace', index=False)
...
dag = DAG(
    dag_id= 'gabriel_martinelli_to_postgres_etl',
