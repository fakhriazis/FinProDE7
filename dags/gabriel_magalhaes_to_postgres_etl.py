...
MINIO_FILE_KEY = 'gabriel_magalhaes_match_logs_2023_2024.json'
...
def load_data_to_postgres():
    ...
    df.to_sql('gabriel_magalhaes_logs', engine, if_exists='replace', index=False)
...
dag = DAG(
    dag_id= 'gabriel_magalhaes_to_postgres_etl',
